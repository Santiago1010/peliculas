...
export const useMoviesStore = defineStore('movies', {
	...
	actions: {
		...
		verifyFavorites(id) {
			console.log(localStorage.favorites === null || localStorage.favorites === "null" || localStorage.favorites === undefined ? true : JSON.parse(localStorage.favorites).filter(m => m.id === parseInt(id))[0])
